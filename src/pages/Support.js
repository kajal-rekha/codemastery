      ...
      <div className="support-team weapper section-padding mt-36">
        ...
        <div className="support grid grid-cols-1 lg:grid-cols-2 mt-14">
          ...
          <div className="right">
            ...
            >
              present for{" "}
              <span className="text-teal-500">round-the-clock </span> support{" "}
              <span className="text-teal-500">messanger</span> group
            </h2>
            <p
            ...
            >
              ...
              group who provide support to each other. Currently, 24-hour
              support is available.Apart from this, you can ask direct questions
              on the discussed topics every day and get answers in group.
            </p>
            <button
