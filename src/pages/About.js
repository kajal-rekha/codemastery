const About = () => {
  return (
    <section className="border-b border-teal-900">
      <div className="about wrapper section-padding mt-10" id="about">
        <h2
        ...
        <div className="about-wrapper grid grid-cols-1 md:grid-cols-2 gap-20 overflow-hidden mt-28">
          ...
          <div className="about-right row-start-1 xl:row-auto">
            ...
            >
              This is a full-free{" "}
              <span className="text-teal-500 ">web development</span> course
              based on React.js
            </p>
            <p className="text-lg" data-aos="fade-up" data-aos-duration="1500">
              ...
              - A3 will have gained valuable skills and knowledge to create
              dynamic and interactive web applications using React. So, get
              ready to embark on a journey to become a skilled web developer!
            </p>
            <a
